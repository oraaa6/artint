    ...
    changeLang() {
        ...
        const translate = () => {
            if(checkSessionStorage() === 'en') {
                ...
                this.sliderHeader.textContent = sliderTranslationNews.eng;
                this.form.innerHTML = '<label class="searching form__searching">Search<input class="searching__input" type="search"></label>';
                changeLanguage(sectionsNewsTranslation.eng, this.sectionsNewsTexts);
           }
            ...
            document.documentElement.lang = 'pl';
                ...
                this.sliderHeader.textContent = sliderTranslationNews.pl;
                this.form.innerHTML = '<label class="searching form__searching">Szukaj<input class="searching__input" type="search"></label>'
                changeLanguage(sectionsNewsTranslation.pl, this.sectionsNewsTexts);
           }
        }
        translate();
