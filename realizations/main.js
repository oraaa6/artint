...
hamburgerButton.forEach(element => element.addEventListener('click', () => {
...
switchLanguage.changeLang(); // SHOW IMAGE IN GALLERY

const showGalleryImage = new ShowImage();
showGalleryImage.showingImageByClick(); // CHANGING SIZE OF FOOTER IMAGE
