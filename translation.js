...
// SWITCH BUTTON
var switchButton = document.querySelector('.menu__lang');
...
var sliderTranslationAbout = {
  pl: 'o nas',
  eng: 'about Us'
}; // SECTION ABOUT US TRANSLATION 

var sectionsAboutTranslation = {
  pl: {
...
var sliderTranslationOffer = {
  pl: 'oferta',
  eng: 'offer'
};
var sectionsOfferTranslation = {
  pl: {
...
var sliderTranslationRealizations = {
  pl: 'realizacje',
  eng: 'realizations'
};
var sectionsRealizationsTranslation = {
  pl: {
...
var sliderTranslationNews = {
  pl: 'aktualności',
  eng: 'news'
};
var sectionsNewsTranslation = {
  pl: {
...
var sliderTranslationContact = {
  pl: 'kontakt',
  eng: 'contact'
};
var sectionsContactTranslation = {
  pl: {
    t1: 'Napisz do nas',
    t2: 'Opinie',
    t3: 'Dodaj opinie',
